...
| **컨테이너화**        | Docker, Docker Compose, Nginx                                 |
| **배포 환경**         | GitHub Pages, Docker Container                                |
...
- **Docker**: 환경 독립적 실행과 일관된 배포 환경 제공

### 컨테이너화

- **Docker + Nginx**: 프로덕션 환경과 동일한 멀티 스테이지 빌드
- **Docker Compose**: 개발자 친화적인 간편한 로컬 실행 환경
- **환경 격리**: Node.js 버전이나 의존성 충돌 없는 안정적 실행
