import{_ as v,r as b,g as O,a as C}from"./@firebase_app@0.10.13-G5arepqD.js";import{L as k}from"./@firebase_logger@0.4.2-CNz1B4Yj.js";import{E as z,g as x,i as G,a as j,v as U,c as T,F as B,d as K,b as W}from"./@firebase_util@1.10.0-CjACHxc0.js";import{C as A}from"./@firebase_component@0.6.9-BT_Gq3Qq.js";import"./@firebase_installations@0.6.9_@firebase_app@0.10.13-ByTbzO8R.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d=new k("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ye{constructor(t){this.app=t}_delete(){return delete h[this.app.options.appId],Promise.resolve()}}let h={},E=[];const M={};let w="dataLayer",we="gtag",R,$,_=!1;function Ie(){const e=[];if(G()&&e.push("This is a browser extension environment."),W()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=u.create("invalid-analytics-context",{errorInfo:t});d.warn(n.message)}}function ve(e,t,n){Ie();const a=e.options.appId;if(!a)throw u.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)d.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw u.create("no-api-key");if(h[a]!=null)throw u.create("already-exists",{id:a});if(!_){Z(w);const{wrappedGtag:s,gtagCore:r}=ie(h,E,M,w,we);$=s,R=r,_=!0}return h[a]=ge(e,E,M,t,R,w,n),new ye(e)}function Fe(e=O()){e=x(e);const t=C(e,y);return t.isInitialized()?t.getImmediate():be(e)}function be(e,t={}){const n=C(e,y);if(n.isInitialized()){const i=n.getImmediate();if(K(t,n.getOptions()))return i;throw u.create("already-initialized")}return n.initialize({options:t})}function Te(e,t,n,a){e=x(e),me($,h[e.app.options.appId],t,n,a).catch(i=>d.error(i))}const D="@firebase/analytics",F="0.10.8";function Ae(){v(new A(y,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return ve(a,i,n)},"PUBLIC")),v(new A("analytics-internal",e,"PRIVATE")),b(D,F),b(D,F,"esm2017");function e(t){try{const n=t.getProvider(y).getImmediate();return{logEvent:(a,i,s)=>Te(n,a,i,s)}}catch(n){throw u.create("interop-component-reg-failed",{reason:n})}}}Ae();export{Fe as g};
